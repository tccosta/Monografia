...
\titulo{Uma solução para o problema de sequenciameto de tarefas em um ambiente indústrial utilizando a heurística GRASP}
\autor{Tiago Carvalho da Costa}
\instituicao{Universidade Estadual do Norte Fluminense Darcy Ribeiro}
\orientador[Tutor: ]{Fermín Alfredo Tang Montané, DrSc.}
...
orientação do Profª. Fermín Alfredo Tang Montané, DrSc.}
...
\include{fundamentos}
\include{grasp}
\include{fabricacao_aco}
\include{modelagem_problema}
